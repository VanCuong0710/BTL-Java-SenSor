...
public class JFrame_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setFont(new java.awt.Font("UTM Amherst", 1, 48)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //SO SÁNH TÀI KHOẢN VS MẬT KHẨU
      
            //TRƯỜNG HỢP ĐĂNG NHẬP ĐÚNG
            JOptionPane.showMessageDialog(rootPane, "Bạn đã đăng nhập thành công");
            JFrame_Menu f =new JFrame_Menu();//KHAI BÁO JFRAME MENU
            f.setLocationRelativeTo(null);
            //GỌI JFRAME MENU
            f.setVisible(true);
            f.setTitle("Menu chức năng");
